        ...
        <>
            ...
            <Container>
                ...
                <Row className="justify-content-center" >
                    <Col xs="auto" >
                        <Button onClick={() => history.push('/Product/AddProduct')} variant="primary" size="lg" >추가등록</Button>
                        &nbsp;<Button onClick={() => window.location.href = '/'} variant="primary" size="lg" >확인</Button>
                    </Col>
                </Row>
